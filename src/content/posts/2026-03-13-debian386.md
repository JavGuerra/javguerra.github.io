...
El usuario `desing`, del foro sobre Sinclair QL [TheQLForum](https://theqlforum.com), me hace la siguiente recomendación: [Kanotix](https://kanotix.com/changelang-eng.html), [Página de descargas](https://iso.kanotix.com).


La principal ventaja de `Kanotix` es que existe una edición específica `eeepc4G` que viene pre-ajustada y optimizada de fábrica para que todo el hardware (WiFi, sonido, cámara, atajos de teclado) funcione sin esfuerzo ("plug and play"). Al estar basada en Debian, es estable y ligera, y su instalador permite además un particionado manual flexible para aprovechar al máximo el limitado espacio de los SSD.


Puede descargarse la iso [kanotix32-towelfire-nightly-eeepc4G.iso](https://iso.kanotix.com/kanotix32-towelfire-nightly-eeepc4G.iso) y probarse en modo _Live_ antes de instalarla.
