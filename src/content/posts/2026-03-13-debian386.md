...
Después de un rato navegando, conseguí encontrar la imagen `debian-12.13.0-i386-netinst.iso` para la arquitectura de 32 bits en el [repositorio CD image de Debian GNU/Linux](https://cdimage.debian.org/cdimage/archive/12.13.0/i386/iso-cd/). Navega por el árbol de directorios para encontrar la versión más reciente si la hay en el futuro,
