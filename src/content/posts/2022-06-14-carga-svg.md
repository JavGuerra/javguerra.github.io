...
02. 
03. function fetchAPI(url, callback, tipo = 'json') {
04.     // setSpin(true);
05.     fetch(url)
06.         .then(respuesta => {
...
<body>
    ...
    <script>
        ...
        function fetchAPI(url, callback, tipo = 'json') {
            // setSpin(true);
            fetch(url)
                .then(respuesta => {
