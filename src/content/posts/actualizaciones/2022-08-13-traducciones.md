...
* Manual en español de Owncloud. Se puede descargar, por ejemplo, de [Nube OwnCloud - Manual de Usuario v0.8](https://es.scribd.com/document/1016898072/Nube-OwnCloud-Manual-de-Usuario-v0-8) Documentación libre. No es una traducción directa del manual, sino un manual elaborado para la administración y gestión del software.
...
* Provincias de España, que estaba en account.limesurvey.org/de/downloads/file/34-provinces-of-spain-provincias-de-espa%C3%B1a?tmpl=component. Un complemento en español para el software [Limesurvey](https://www.limesurvey.org/es/).
