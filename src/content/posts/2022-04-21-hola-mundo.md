...
<span class="note">**Nota**: Esta entrada hace referencia a la versión inicial de este blog realizado con Jekill. El repositorio de esa versión del blog es: [blog](https://github.com/JavGuerra/codice-beautiful-jekyll-es).</span>
