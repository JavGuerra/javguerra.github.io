...
La caja elegida es una [Jonsbo N4 White](https://www.jonsbo.com/en/products/N4White.html) como la que se muestra en la foto de esta entrada. La he adquirido en la tienda Xtremmedia, por 119,09€. Elegí el color blanco porque es el que mejor se mimetiza con la estantería. **Nota**: la tienda online ubicada en "www.xtremmedia.com/", y la tienda física ya no existen.
...
*Actualización*: Una vez recibida, la caja cumplió mis expectativas, pero ha necesitado dos compras suplementarias. Por un lado, el ventilador de la caja es ruidoso. No es algo desesperante, pero supera el nivel de ruido que busco, por ello he comprado en Amazon un sustituto por 32,90€, el [Noctua NF-A12x25 PWM](https://noctua.at/es/nf-a12x25-pwm). También he necesitado un cable extensor de alimentación ATX 24 pines que he comprado en Aliexpress por 3,19€, pues el de la fuente de alimentación se quedaba corto. Si bien las instrucciones de montaje de la caja proponen pasar el cable de alimentación por debajo de la placa base, entre el chasis y la placa, este espacio es muy justo, y alguna soldadura de la placa base podría dañar el cable de alimentación y hacer un corto. Por ese precio no merece la pena arriesgarse.
